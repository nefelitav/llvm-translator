...
define i32 @Visitor.visit(i8* %this, i8* %.n) {
	...
	%_5 = bitcast i8* %_4 to i1 (i8* )*
	%_6 = call i1 %_5(i8* %_0 )
	br i1 %_6, label %if_then_54, label %if_else_54
	...
	br i1 %_31, label %if_then_56, label %if_else_56
...
define i32 @MyVisitor.visit(i8* %this, i8* %.n) {
	...
	%_5 = bitcast i8* %_4 to i1 (i8* )*
	%_6 = call i1 %_5(i8* %_0 )
	br i1 %_6, label %if_then_58, label %if_else_58
	...
	br i1 %_38, label %if_then_60, label %if_else_60
