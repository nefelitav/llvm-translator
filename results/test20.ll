...
define i32 @B23.init(i8* %this, i8* %.a) {
	...
	%_16 = getelementptr i8, i8* %this, i32 24
	%_17 = bitcast i8* %_16 to i32*
	%_18 = load i32, i32* %_17
	%_19 = bitcast i8* %_15 to i32 (i8* , i32)*
	%_20 = call i32 %_19(i8* %this , i32 %_18)
...
define i32 @C23.init(i8* %this, i8* %.a) {
	...
	%_6 = getelementptr i8, i8* %this, i32 32
	%_7 = bitcast i8* %_6 to i32*
	%_8 = load i32, i32* %_7
	%_9 = bitcast i8* %_5 to i32 (i8* , i32)*
	%_10 = call i32 %_9(i8* %this , i32 %_8)
